...
/*Store in temporary variable*/
    st_app.lfFarRightVal = st->lfFarRightVal;
    st_app.lfMidRightVal = st->lfMidRightVal;	
    st_app.lfFarLeftVal = st->lfFarLeftVal;
    st_app.lfMidLeftVal = st->lfMidLeftVal;
/*Switch sensor readings*/	
    st->lfFarRightVal = st_app.lfFarLeftVal;
    st->lfMidRightVal = st_app.lfMidLeftVal;	
    st->lfFarLeftVal = st_app.lfFarRightVal;
    st->lfMidLeftVal = st_app.lfMidRightVal;
