...
\begin{itemize}
	\item Control: Attacks that are implemented changing the code of the
		Controller FMU\@.
% \begin{figure}[H]
% \includegraphics[width = 17cm]{img/Attack_control_diagram.pdf}
% \end{figure}
	\item FMU\@: Attacks implemented using additional FMUs placed between
		two legitimate FMUs.
% \begin{figure}[H]
% \includegraphics[width = 17cm]{img/FMU_attack_diagram.pdf}
% \end{figure}
\end{itemize}
...
\input{attacks/control_attacks}
\newpage
\input{attacks/FMU_attacks}
